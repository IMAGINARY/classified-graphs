...
const en: Locale = {
  ...
  resource: {
    translation: {
      ...
      Degree_sequence_Tip: 'List of the degrees of each node, in decreasing order. The degree of a node is the number of edges connected to it.',
      Connected_components: 'Connected components',
      Connected_components_Tip: 'Each component is the set of nodes and edges connected together.',
      ...
      Adjacency_det_Tip: 'The adjacency matrix is built by setting a<sub>ij</sub> equal to the number of edges from node i to node j. Its determinant is an invariant of the graph.',
